...
>(({ className, ...rest }, forwardedRef) => {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // base
        'fixed inset-0 z-50 flex flex-col items-center justify-center overflow-y-auto bg-black/20 p-4 backdrop-blur-[10px]',
        // animation
      ...
      <ModalPortal>
        <ModalOverlay className={overlayClassName}>
          <DialogPrimitive.Content
            ...
            className={cn(
              // base
              'relative w-full max-w-[400px] border border-foreground/10',
              'rounded-20 bg-background shadow-regular-md p-2.5',
              // focus
              'focus:outline-none',
              // animation

...
const commandItemVariants = tv({
  base: [
    ...
    'transition duration-200 ease-out',
    // hover/selected
    'data-[selected=true]:bg-foreground/5 rounded-md',
  ],
  variants: {
    size: {
      small: 'px-3 py-2.5',
...
function CommandFooterKeyBox({
  ...
  return (
    <div
      className={cn(
        'flex size-5 shrink-0 items-center justify-center rounded bg-bg-weak-50 text-text-sub-600 ring-1 ring-inset ring-foreground/10',
        className,
      )}
      {...rest}
    />
